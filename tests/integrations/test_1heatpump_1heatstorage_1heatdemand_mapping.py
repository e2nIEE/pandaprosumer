...
class Test1HeatPump1HeatStorage1HeatDemandMapping:
    ...
    def test_fluid_mix_mapping(self):
        ...
        data = pd.DataFrame({
            "Tin_evap": [25] * 5,
            "demand_kw": [0, 100, 200, 150, 50],
            "t_feed_demand_c": [t_high_c] * 5,
            "t_return_demand_c": [t_low_c] * 5
        })
        ...
        hp_data = {
            ...
            'q_evap_kw': [0., 0., 0., 0., 0.],
            'cop': [0., 0., 0., 0., 0.],
            'mdot_cond_kg_per_s': [0., 0., 0., 0., 0.],
            't_cond_in_c': [0., 0., 0., 0., 0.],
            't_cond_out_c': [0., 0., 0., 0., 0.],
            'mdot_evap_kg_per_s': [0., 0., 0., 0., 0.],
            't_evap_in_c': [0., 0., 0., 0., 0.],
            't_evap_out_c': [0., 0., 0., 0., 0.]
        }
        hp_expected = pd.DataFrame(hp_data, index=data.index)

        hs_data = {
            'soc': [1., 0., 0., 0., 0.],
            'q_delivered_kw': [-999.539525, 0., 0., 0., 0.],
        }
        hs_expected = pd.DataFrame(hs_data, index=data.index)

        dmd_data = {
            'q_received_kw': [0., 0., 0., 0., 0.],
            'q_uncovered_kw': [0., 0., 0., 0., 0.],
            'mdot_kg_per_s': [0., 0., 0., 0., 0.],
            't_in_c': [0., 0., 0., 0., 0.],
            't_out_c': [0., 0., 0., 0., 0.]
        }
