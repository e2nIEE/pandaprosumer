...
period_id = create_period(prosumer, resol, start, end, 'utc', 'default')
...
print(prosumer.time_series.data_source.loc[0].df)

# PLOTTING
demand_data.plot()
plt.show()

prosumer.time_series.data_source.loc[0].df.q_cond_kw.plot()
plt.show()
