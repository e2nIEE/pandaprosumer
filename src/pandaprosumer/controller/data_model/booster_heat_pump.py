...
class BoosterHeatPumpControllerData:
    ...
    input_columns : List[str]
        List of input column names. Inputs are: t_source_k, t_sink_K, demand, mode, q_received_kw, p_received_kw.
    ...
    input_columns: List[str] = field(default_factory=lambda: ['t_source_k', 't_sink_k', 'demand', 'mode', 'q_received_kw', 'p_received_kw'])
